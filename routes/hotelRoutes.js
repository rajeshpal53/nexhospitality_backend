...
router.post('/', upload.fields([
    ...
    { name: 'coverImages', maxCount: 5},]), compressAndSaveImage, hotelController.createHotel);
...
router.put('/:id', upload.fields([
    { name: 'hotelImages', maxCount: 5},
    { name: 'coverImages', maxCount: 5}]), compressAndSaveImage, hotelController.updateHotel);
